...
@section('content')
    ...
    <p class="mb-4">In this page {{ app('NAME') }} admins can add new product in database</p>
...
{{-- 	<div class="alert alert-warning alert-dismissible fade show" role="alert">
 	...
 	<form class="text-center border border-light" action="/admin/other/add" method="POST" enctype="multipart/form-data">
 		@csrf
 		<input type="hidden" name="user_id" value="{{ Auth::user()->id }}">

 		<input type="text" class="form-control mb-4" placeholder="Name. ex. Carrot" name="name" value="{{ old('name') }}"  required>
 		...
 		<input type="text" class="form-control mb-4" placeholder="Condition. ex. Fresh" name="condition" value="{{ old('condition') }}">
