        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              @php $data = getConfig('data.json'); @endphp
              <img class="col-lg-6 d-none d-lg-block" src="{{ $data['admin_login_image'] }}">
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-user @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" id="username" placeholder="Enter Username">
